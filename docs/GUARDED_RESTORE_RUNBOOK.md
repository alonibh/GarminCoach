...
> Phase 6B3B2 (configured replacement, postcheck, rollback, and re-entry) is in progress. Phase 6B3B3 (apply CLI) remains unimplemented and requires separate review and approval. No production restore command or drill exists yet.
