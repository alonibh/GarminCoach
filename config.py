...
MORNING_WATCH_INTERVAL_MINUTES = int(os.getenv("MORNING_WATCH_INTERVAL_MINUTES", "15"))
MORNING_WATCH_START_HOUR = int(os.getenv("MORNING_WATCH_START_HOUR", "7"))
MORNING_WATCH_END_HOUR = int(os.getenv("MORNING_WATCH_END_HOUR", "12"))
CAPABILITY_PROBE_INTERVAL_DAYS = int(os.getenv("CAPABILITY_PROBE_INTERVAL_DAYS", "7"))
...
GOOGLE_CLIENT_ID = os.getenv("GOOGLE_CLIENT_ID", "dummy-google-client-id.apps.googleusercontent.com").strip()
GOOGLE_CLIENT_SECRET = os.getenv("GOOGLE_CLIENT_SECRET", "dummy-google-client-secret").strip()
