...
_ALIASES = {
    ...
    "LEG_PRESS_CALF_RAISE": "CALF_RAISE:STANDING_CALF_RAISE",
    ...
    "GLUTE_KICK_BACKS": "HIP_STABILITY:QUADRUPED_HIP_EXTENSION",
    ...
    "SMITH_MACHINE_ROW": "ROW:BENT_OVER_ROW_WITH_BARBELL",
    ...
    # Sustainable-default catalog additions. These preserve the source-facing
    # names while selecting the closest Garmin FIT strength enum.
    "BANDED_HAMSTRING_CURL": "BANDED_EXERCISES:HAMSTRING_CURLS",
    "BANDED_TRICEP_EXTENSION": "BANDED_EXERCISES:TRICEP_EXTENSION",
    "BARBELL_AB_ROLLOUT": "CORE:BARBELL_ROLLOUT",
    "BARBELL_CALF_RAISE": "CALF_RAISE:STANDING_BARBELL_CALF_RAISE",
    "BARBELL_GLUTE_BRIDGE": "HIP_RAISE:BARBELL_HIP_THRUST_ON_FLOOR",
    "BENT_OVER_DUMBBELL_ROW": "ROW:BENT_OVER_ROW_WITH_DUMBELL",
    "BULGARIAN_SPLIT_SQUAT": "LUNGE:DUMBBELL_BULGARIAN_SPLIT_SQUAT",
    "CLOSE_GRIP_BENCH_PRESS": "BENCH_PRESS:CLOSE_GRIP_BARBELL_BENCH_PRESS",
    "CLOSE_GRIP_DUMBBELL_PRESS": "BENCH_PRESS:NEUTRAL_GRIP_DUMBBELL_BENCH_PRESS",
    "DUMBBELL_CALF_RAISE": "CALF_RAISE:STANDING_DUMBBELL_CALF_RAISE",
    "DUMBBELL_FLY": "FLYE:DUMBBELL_FLYE",
    "DUMBBELL_FROG_SQUAT": "SQUAT:WIDE_STANCE_GOBLET_SQUAT",
    "DUMBBELL_HAMSTRING_CURL": "LEG_CURL:WEIGHTED_LEG_CURL",
    "DUMBBELL_HIP_THRUST": "HIP_RAISE:BARBELL_HIP_THRUST_WITH_BENCH",
    "DUMBBELL_MILITARY_PRESS": "SHOULDER_PRESS:DUMBBELL_SHOULDER_PRESS",
    "DUMBBELL_PLIE_SQUAT": "SQUAT:PLIE_SQUAT",
    "DUMBBELL_REAR_DELT_FLY": "LATERAL_RAISE:SEATED_REAR_LATERAL_RAISE",
    "DUMBBELL_SIDE_BEND": "CORE:WEIGHTED_SIDE_BEND",
    "DUMBBELL_TRICEP_EXTENSION": "TRICEPS_EXTENSION:OVERHEAD_DUMBBELL_TRICEPS_EXTENSION",
    "DUMBBELL_TRICEP_KICKBACK": "TRICEPS_EXTENSION:DUMBBELL_KICKBACK",
    "FLOOR_PRESS": "BENCH_PRESS:BARBELL_FLOOR_PRESS",
    "LANDMINE_LATERAL_RAISE": "LATERAL_RAISE:LEANING_DUMBBELL_LATERAL_RAISE",
    "LANDMINE_SQUAT": "SQUAT:GOBLET_SQUAT",
    "LYING_DUMBBELL_TRICEP_EXTENSION": "TRICEPS_EXTENSION:DUMBBELL_LYING_TRICEPS_EXTENSION",
    "MEADOWS_ROW": "ROW:ONE_ARM_BENT_OVER_ROW",
    "OVERHEAD_DUMBBELL_TRICEP_EXTENSION": "TRICEPS_EXTENSION:OVERHEAD_DUMBBELL_TRICEPS_EXTENSION",
    "PINWHEEL_CURL": "CURL:DUMBBELL_HAMMER_CURL",
    "POWER_CLEAN": "OLYMPIC_LIFT:BARBELL_POWER_CLEAN",
    "PUSH_PRESS": "SHOULDER_PRESS:BARBELL_PUSH_PRESS",
    "REVERSE_GRIP_BARBELL_CURL": "CURL:REVERSE_GRIP_BARBELL_BICEPS_CURL",
    "REVERSE_GRIP_DUMBBELL_PRESS": "BENCH_PRESS:REVERSE_GRIP_BARBELL_BENCH_PRESS",
    "REVERSE_GRIP_DUMBBELL_ROW": "ROW:REVERSE_GRIP_BARBELL_ROW",
    "SEATED_DUMBBELL_CALF_RAISE": "CALF_RAISE:SEATED_DUMBBELL_TOE_RAISE",
    "SEATED_DUMBBELL_SHRUG": "SHRUG:DUMBBELL_SHRUG",
    "SEATED_DUMBBELL_TRICEP_EXTENSION": "TRICEPS_EXTENSION:SEATED_DUMBBELL_OVERHEAD_TRICEPS_EXTENSION",
    "SEATED_FRENCH_PRESS": "TRICEPS_EXTENSION:SEATED_BARBELL_OVERHEAD_TRICEPS_EXTENSION",
    "SINGLE_ARM_LANDMINE_PRESS": "SHOULDER_PRESS:ONE_ARM_PUSH_PRESS",
    "SINGLE_LEG_CALF_RAISE": "CALF_RAISE:SINGLE_LEG_STANDING_CALF_RAISE",
    "SINGLE_LEG_GOOD_MORNING": "LEG_CURL:SINGLE_LEG_BARBELL_GOOD_MORNING",
    "STANDING_DUMBBELL_CURL": "CURL:STANDING_DUMBBELL_BICEPS_CURL",
    "STIFF_LEG_DEADLIFT": "DEADLIFT:STRAIGHT_LEG_DEADLIFT",
    "TRIPOD_DUMBBELL_ROW": "ROW:DUMBBELL_ROW",
    "YATES_ROW": "ROW:REVERSE_GRIP_BARBELL_ROW",
    "ZOTTMAN_CURL": "CURL:STANDING_ZOTTMAN_BICEPS_CURL",
}
