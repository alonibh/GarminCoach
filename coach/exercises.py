...
_ALIASES = {
    ...
    "DUMBBELL_PULLOVER": "PULL_UP:EZ_BAR_PULLOVER",
    ...
    "REVERSE_BARBELL_CURL": "CURL:REVERSE_GRIP_BARBELL_BICEPS_CURL",
    ...
    "SEATED_SHOULDER_PRESS": "SHOULDER_PRESS:SEATED_DUMBBELL_SHOULDER_PRESS",
