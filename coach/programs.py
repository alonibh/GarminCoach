    ...
    "total_package_3": _program(
        ...
        [
            _session("Day 1", "full body", [
                _exercise("Squat", 5, 5, rest=90), _exercise("Dumbbell Bench Press", 4, 10, rest=90),
                _exercise("Dumbbell Row", 4, 10, rest=90), _exercise("Seated Dumbbell Press", 4, 10, rest=90),
                _exercise("Lunge", 4, 10, rest=90), _exercise("Dumbbell Curl", 3, 10, rest=90),
                _exercise("Standing Barbell Tricep Extension", 3, 10, rest=90), _exercise("Calf Raise", 3, 12, rest=90),
                _exercise("Plank", 5, None, rest=90, duration=20),
            ], 90),
            _session("Day 2", "full body", [
                _exercise("Bench Press", 5, 5, rest=90), _exercise("Machine Pec Deck", 3, 12, rest=90),
                _exercise("Leg Extension", 4, 10, rest=90), _exercise("Leg Curl", 4, 10, rest=90),
                _exercise("Pullup", 4, 10, rest=90), _exercise("Seated Lateral Raise", 4, 10, rest=90),
                _exercise("Dumbbell Hammer Curls", 3, 10, rest=90), _exercise("Rope Extension", 3, 10, rest=90),
                _exercise("Plank", 5, None, rest=90, duration=20),
            ], 90),
            _session("Day 3", "full body", [
                _exercise("Deadlift", 5, 5, rest=90), _exercise("Incline Dumbbell Press", 4, 10, rest=90),
                _exercise("Lateral Raise", 4, 10, rest=90), _exercise("Pulldown", 4, 10, rest=90),
                _exercise("Leg Press", 4, 10, rest=90), _exercise("EZ Bar Curl", 3, 10, rest=90),
                _exercise("Skullcrushers", 3, 10, rest=90), _exercise("Dumbbell Shrugs", 3, 12, rest=90),
                _exercise("Plank", 5, None, rest=90, duration=20),
            ], 90),
        ],
