...
PROGRAMS.update({
    "planet_fitness_full_body_3": _program(
        ...
        "https://www.muscleandstrength.com/workouts/3-day-full-body-planet-fitness-workout", "new", [
            _session("Full Body A", "full body", [
                ...
                _exercise("Standing Calf Raise", 2, 15),
            ...
            _session("Full Body B", "full body", [
                ...
                _exercise("Skullcrusher", 3, 10), _exercise("Dumbbell Curl", 3, 10),
            ], 70),
    ...
    "whole_body_toning_3": _program(
        ...
        "https://www.muscleandstrength.com/workouts/3-day-whole-body-toning-workout.html", "six_to_twenty_four_months", [
            _session("Series 1", "full body", [
                _exercise("Leg Press", 3, 20, rest=45), _exercise("Seated Cable Row", 3, 20, rest=45),
                _exercise("Machine Tricep Dip", 2, 15, rest=45, notes="Source movement: chest dip"),
                _exercise("Machine Shoulder Press", 2, 20, rest=45),
                _exercise("Cable Curl", 2, 20, rest=45),
                _exercise("Cable Tricep Extensions", 2, 20, rest=45),
                _exercise("Plank", 3, None, duration=60, rest=45),
            ], 30),
            _session("Series 2", "full body", [
                _exercise("Smith Machine Front Squat", 3, 20, rest=45),
                _exercise("Seated Calf Raise", 2, 25, rest=45),
                _exercise("Lat Pull Down", 3, 20, rest=45),
                _exercise("Cable Fly", 3, 20, movement="horizontal_push", rest=45, notes="Source movement: dumbbell fly"),
                _exercise("Dumbbell Tricep Kickback", 2, 20, rest=45),
                _exercise("Standing Dumbbell Curl", 2, 20, rest=45),
                _exercise("Sit Up", 2, None, rest=45, notes="Use a decline bench"),
            ], 30),
            _session("Series 3", "full body", [
                _exercise("Dumbbell Lunge", 4, 10, rest=45), _exercise("Wide Grip Pull Up", 3, None, rest=45),
                _exercise("Barbell Bench Press", 3, 15, rest=45),
                _exercise("Barbell Curl", 3, 15, rest=45, notes="Source movement: standing barbell curl"),
                _exercise("Bench Dip", 3, 15, rest=45, notes="Source movement: tricep bench dip"),
                _exercise("Hanging Leg Raise", 2, None, rest=45, notes="Source movement: horizontal leg raise"),
            ], 30),
        ], "Three short full-body sessions; source rest 30-45 s applied; movement aliases noted.",
    ),
    "planet_fitness_upper_lower_4": _program(
        ...
        "https://www.muscleandstrength.com/workouts/4-day-upper-lower-planet-fitness-workout", "new", [
            _session("Upper A", "upper body", [
                _exercise("Dumbbell Bench Press", 4, 8), _exercise("Pec Deck", 3, 10, notes="Source movement: machine chest fly"),
                _exercise("Dumbbell Row", 4, 8), _exercise("Lat Pull Down", 4, 8),
                _exercise("Machine Shoulder Press", 4, 8), _exercise("Dumbbell Lateral Raise", 3, 10),
                _exercise("Machine Tricep Dip", 2, 10), _exercise("Cable Curl", 2, 10),
            ], 70),
            _session("Lower A", "lower body", [
                _exercise("Leg Press", 4, 8), _exercise("Dumbbell Stiff Leg Deadlift", 4, 8),
                _exercise("Leg Extension", 3, 12), _exercise("Leg Curl", 3, 12),
                _exercise("Glute Kick Backs", 3, 12, notes="Source movement: machine glute kickback"),
                _exercise("Standing Calf Raise", 3, 20),
            ], 70),
            _session("Upper B", "upper body", [
                _exercise("Seated Dumbbell Press", 4, 8), _exercise("Cable Face Pull", 3, 10, movement="horizontal_pull"),
                _exercise("Smith Machine Row", 4, 8, movement="horizontal_pull"),
                _exercise("Pull Up", 4, 8, notes="Use the assisted pull-up machine"),
                _exercise("Incline Dumbbell Bench Press", 4, 8), _exercise("Cable Fly", 3, 10, movement="horizontal_push"),
                _exercise("Dumbbell Curl", 2, 10), _exercise("Skullcrusher", 2, 10),
            ], 70),
            _session("Lower B", "lower body", [
                _exercise("Goblet Squat", 4, 10),
                _exercise("Barbell Hip Thrust", 4, 8, notes="Source movement: smith machine hip thrust"),
                _exercise("Dumbbell Deadlift", 4, 8), _exercise("Dumbbell Lunge", 3, 10),
                _exercise("Seated Leg Curl", 3, 12), _exercise("Seated Calf Raise", 3, 20),
            ], 70),
        ], "Two machine-and-dumbbell upper and lower exposures; source rest 60-90 s, 60 s applied.",
    ),
    "optimized_volume_4": _program(
        "Optimized Volume · 4 days", "https://www.muscleandstrength.com/workouts/ovw-workout", "new", [
            _session("Upper 1", "upper body", [
                _exercise("Bench Press", 4, 6), _exercise("Barbell Row", 4, 6),
                _exercise("Incline Dumbbell Press", 3, 8), _exercise("Lat Pull Down", 3, 8),
                _exercise("Lateral Raise", 3, 10), _exercise("Dumbbell Curl", 3, 10),
                _exercise("Lying EZ Bar Triceps Extension", 3, 10, notes="Source movement: lying tricep extension"),
            ], 60),
            _session("Lower 1", "lower body", [
                _exercise("Squat", 4, 6), _exercise("Lunge", 3, 8),
                _exercise("Leg Curl", 3, 10), _exercise("Calf Raise", 4, 10),
                _exercise("Cable Crunch", 4, 10),
            ], 60),
            _session("Upper 2", "upper body", [
                _exercise("Overhead Press", 4, 6), _exercise("Pullup", 4, 6),
                _exercise("Incline Dumbbell Bench Press", 3, 8), _exercise("Seated Cable Row", 3, 8),
                _exercise("Dumbbell Fly", 3, 10), _exercise("Barbell Curl", 3, 10),
                _exercise("Tricep Pushdown", 3, 10, notes="Source movement: cable tricep pushdown"),
            ], 60),
            _session("Lower 2", "lower body", [
                _exercise("Romanian Deadlift", 4, 6), _exercise("Leg Press", 3, 8),
                _exercise("Leg Extension", 3, 10), _exercise("Seated Calf Raise", 4, 10),
                _exercise("Cable Crunch", 4, 10),
            ], 60),
        ], "Source upper/lower structure; full exercise roster; source is silent on rest, 60 s GarminCoach default applied.",
    ),
    "phul_4": _program(
        "PHUL Power / Hypertrophy · 4 days", "https://www.muscleandstrength.com/workouts/phul-workout", "six_to_twenty_four_months", [
            _session("Upper Power", "upper body", [
                _exercise("Barbell Bench Press", 4, 3, rest=180), _exercise("Incline Dumbbell Bench Press", 3, 6),
                _exercise("Bent Over Row", 4, 3, rest=180), _exercise("Lat Pull Down", 3, 6),
                _exercise("Overhead Press", 2, 6),
                _exercise("Barbell Curl", 2, 6), _exercise("EZ Bar Skullcrusher", 2, 6),
            ], 60),
            _session("Lower Power", "lower body", [
                _exercise("Squat", 4, 3, rest=180), _exercise("Deadlift", 4, 3, rest=180),
                _exercise("Leg Press", 3, 10), _exercise("Leg Curl", 3, 6),
                _exercise("Standing Calf Raise", 4, 8),
            ], 60),
            _session("Upper Hypertrophy", "upper body", [
                _exercise("Incline Barbell Bench Press", 4, 8), _exercise("Dumbbell Fly", 3, 10),
                _exercise("Seated Cable Row", 4, 8), _exercise("One Arm Dumbbell Row", 3, 8),
                _exercise("Dumbbell Lateral Raise", 3, 10),
                _exercise("Incline Dumbbell Biceps Curl", 3, 10), _exercise("Cable Tricep Extensions", 3, 10),
            ], 60),
            _session("Lower Hypertrophy", "lower body", [
                _exercise("Front Squat", 4, 8), _exercise("Barbell Lunge", 4, 8),
                _exercise("Leg Extension", 3, 10), _exercise("Leg Curl", 3, 10),
                _exercise("Seated Calf Raise", 3, 10), _exercise("Leg Press Calf Raise", 3, 10, notes="Source movement: calf press"),
            ], 60),
        ], "Power and hypertrophy sessions each train upper and lower body; full source exercise roster.",
    ),
    ...
    "barbell_no_rack_4": _program(
        "Barbell Only (No Rack) · 4 days", "https://www.muscleandstrength.com/workouts/4-day-barbell-only-workout", "six_to_twenty_four_months", [
            ...
            _session("Lower B", "lower body", [
                ...
                _exercise("Standing Hip Abduction", 2, 15, notes="Source movement: standing banded hip abduction"),
    ...
    "muscle_mania_6": _program(
        "Muscle Mania Upper / Lower · 6 days", "https://www.muscleandstrength.com/workouts/muscle-mania-10-week-muscle-growth-workout", "two_plus_years", [
            _session("Upper 1", "upper body", [
                _exercise("Bent Over Row", 4, 6), _exercise("Barbell Bench Press", 4, 6),
                _exercise("Lat Pull Down", 3, 8),
                _exercise("Dumbbell Lateral Raise", 3, 8, rest=45, notes="Source movement: seated side lateral raise"),
                _exercise("Barbell Curl", 3, 12, rest=45),
                _exercise("Seated Overhead EZ Bar Tricep Extension", 3, 12, rest=45, notes="Source movement: French press"),
            ], 75),
            _session("Lower 1", "lower body", [
                _exercise("Squat", 4, 6), _exercise("Romanian Deadlift", 4, 6),
                _exercise("Dumbbell Reverse Lunge", 3, 8, notes="Source movement: dumbbell rear lunge"),
                _exercise("Leg Curl", 3, 8, rest=45),
                _exercise("Seated Calf Raise", 4, 15, rest=45),
                _exercise("Cable Crunch", 4, 15, rest=45, notes="Source movement: machine crunch"),
            ], 75),
            _session("Upper 2", "upper body", [
                _exercise("Pull Up", 4, 8), _exercise("Incline Dumbbell Bench Press", 4, 8),
                _exercise("Seated Cable Row", 3, 8), _exercise("Seated Dumbbell Press", 3, 8),
                _exercise("EZ Bar Preacher Curl", 3, 12, rest=45, notes="Source movement: machine preacher curl"),
                _exercise("Machine Tricep Dip", 3, 12),
            ], 75),
            _session("Lower 2", "lower body", [
                _exercise("Leg Press", 4, 8), _exercise("Barbell Glute Bridge", 4, 8),
                _exercise("Leg Extension", 3, 12, rest=45),
                _exercise("Seated Leg Curl", 3, 12, rest=45),
                _exercise("Standing Calf Raise", 4, 8, rest=45),
                _exercise("Cable Crunch", 4, 15, rest=45, notes="Source movement: machine crunch"),
            ], 75),
            _session("Upper 3", "upper body", [
                _exercise("Pec Deck", 4, 12, rest=45, notes="Source movement: machine pec dec"),
                _exercise("Dumbbell Lateral Raise", 3, 12, rest=45, notes="Source movement: machine lateral raise"),
                _exercise("Machine Row", 4, 12),
                _exercise("Dumbbell Rear Delt Lateral Raise", 3, 12, rest=45, notes="Source movement: machine reverse fly"),
                _exercise("Weighted Dips", 3, 6, notes="Source movement: bodyweight dip"),
            ...
            _session("Lower 3", "lower body", [
                ...
                _exercise("Leg Press Calf Raise", 4, 10, rest=45, notes="Source movement: leg press calf press"),
                _exercise("Cable Crunch", 4, 15, rest=45, notes="Source movement: machine crunch"),
            ], 75),
